...
\begin{figure}
  ...
  \qquad
  \subfloat[por retro reflexão]{\includegraphics[width=0.4\textwidth]{figuras/sensorOpticoRetro}}

  \subfloat[por barreira]{\includegraphics[width=0.4\textwidth]{figuras/sensorOpticoBarreira}}
...
\end{figure}
\item[Repetibilidade] Capacidade do instrumento de reproduzir as mesmas saídas
quando as mesmas entradas são aplicadas, sob as mesmas condições.
